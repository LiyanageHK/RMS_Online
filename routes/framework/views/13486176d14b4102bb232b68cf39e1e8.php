...
<div style="display: flex; justify-content: center; width: 100%; margin-top: 40px;">
    <div style="width: 90%; max-width: 1000px; border: 2px solid #ddd; padding: 30px; background-color: #ffffff; border-radius: 10px; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1); position: relative;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            ...
            <a href="<?php echo e(route('purchase_orders.index')); ?>" title="Cancel" style="color: #666; text-decoration: none;">
                <span class="material-icons" style="font-size: 28px;">close</span>
            </a>
        </div>

        <form action="<?php echo e(route('purchase_orders.update', $po->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div style="border: 1px solid #ddd; padding: 20px; border-radius: 8px; background-color: #F9F9F9; margin-bottom: 30px;">
                <div style="margin-bottom: 20px;">
                    ...
                    <select id="supplier_id" name="supplier_id" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($supplier->id); ?>" <?php echo e($supplier->id == $po->supplier_id ? 'selected' : ''); ?>>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="date" id="order_date" name="order_date" value="<?php echo e($po->order_date); ?>" readonly style="width: 98%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                </div>

                <div style="margin-bottom: 20px;">
                    <label for="delivery_date" style="font-weight: bold;">Delivery Date</label>
                    <input type="date" id="delivery_date" name="delivery_date" value="<?php echo e($po->delivery_date); ?>" style="width: 98%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                </div>

                <div>
                    <label for="total_amount" style="font-weight: bold;">Total Amount </label>
                    <input type="text" id="total_amount" name="total_amount" readonly style="width: 98%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #f3f3f3;" value="<?php echo e(number_format($po->total_amount, 2)); ?>">
                </div>
            </div>
                ...
                <div style="margin-bottom: 10px;">
                    <select id="item_select" style="width: 99%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; padding-right: 30px;">
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>" data-name="<?php echo e($item->name); ?>" data-price="<?php echo e($item->price); ?>">
                                <?php echo e($item->name); ?> - $<?php echo e(number_format($item->price, 2)); ?>
                ...
                <table id="items_table" style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $po->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-id="<?php echo e($poItem->item_id); ?>">
                                <td style="padding: 10px;">
                                    <?php echo e($poItem->item->name); ?>

                                    <input type="hidden" name="items[<?php echo e($poItem->item_id); ?>][item_id]" value="<?php echo e($poItem->item_id); ?>">
                                    <input type="hidden" name="items[<?php echo e($poItem->item_id); ?>][name]" value="<?php echo e($poItem->item->name); ?>">
                                </td>
                                <td style="padding: 10px;">
                                    $<?php echo e(number_format($poItem->price, 2)); ?>

                                    <input type="hidden" name="items[<?php echo e($poItem->item_id); ?>][price]" value="<?php echo e($poItem->price); ?>">
                                </td>
                                <td style="padding: 10px;">
                                    <input type="number" name="items[<?php echo e($poItem->item_id); ?>][quantity]" value="<?php echo e($poItem->quantity); ?>" min="1" class="qty-input" style="width: 60px; padding: 5px;">
                                </td>
                                <td class="item-total" style="padding: 10px;">
                                    $<?php echo e(number_format($poItem->price * $poItem->quantity, 2)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\PurchaseOrders\edit.blade.php ENDPATH**/ ?>