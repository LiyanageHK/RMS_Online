    ...
    <div class="wrapper">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end profile-dropdown" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('employees.profile')); ?>">
                                    <i class="fas fa-user"></i> Profile
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('employees.changePasswordForm')); ?>">
        ...
        <aside class="main-sidebar" style="width: 250px; background-color: #ffffff; color: #333; padding: 20px; box-shadow: 2px 0px 8px rgb(255, 255, 255); display: flex; flex-direction: column; min-height: 100vh;">
            ...
            <div style="text-align: center; margin-bottom: 25px;">
                <img src="<?php echo e(asset('uploads/logo/logo2.png')); ?>" alt="Logo" style="width: 80px;">
            ...
            <div id="sidebarMenu" style="flex-grow: 1;">
                <a href="<?php echo e(route('home')); ?>" class="sidebar-btn <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
                ...
                <div id="inventorynav">
                    ...
                    <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
                        <a href="<?php echo e(route('admin.inventory.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.inventory.index') ? 'active' : ''); ?>">Inventory Status</a>
                        <a href="<?php echo e(route('admin.categories.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">Item Category</a>
                        <a href="<?php echo e(route('admin.items.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.items.*') ? 'active' : ''); ?>">Item</a>
                        <a href="<?php echo e(route('admin.productcategories.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.productcategories.*') ? 'active' : ''); ?>">Product Category</a>
                        <a href="<?php echo e(route('admin.production.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.production.*') ? 'active' : ''); ?>">Product</a>
                    </div>
                </div>
...
<div id="pronav">
    ...
    <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
        <a href="<?php echo e(route('suppliers.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('suppliers.*') ? 'active' : ''); ?>">Suppliers</a>
        <a href="<?php echo e(route('purchase_orders.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('purchase_orders.*') ? 'active' : ''); ?>">Purchase Orders</a>
        <a href="<?php echo e(route('grns.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('grns.*') ? 'active' : ''); ?>">Good Received Notes</a>
    </div>
</div>
...
<div id="empnav">
    ...
    <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
        <a href="<?php echo e(route('employees.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('employees.*') ? 'active' : ''); ?>">Employees</a>
    </div>
</div>
                ...
                <div id="accnav">
                    ...
                    <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
                        <a href="<?php echo e(route('admin.role.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('admin.role.*') ? 'active' : ''); ?>">Role</a>
                    </div>
                </div>
            </div>
    ...
    <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
        <a href="<?php echo e(route('contact.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('contact.*') ? 'active' : ''); ?>">Contact Messages</a>
        <a href="<?php echo e(route('feedback.index')); ?>" class="submenu-link <?php echo e(request()->routeIs('feedback.*') ? 'active' : ''); ?>">Feedback Messages</a>
    </div>
...
<?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views/layouts/app.blade.php ENDPATH**/ ?>