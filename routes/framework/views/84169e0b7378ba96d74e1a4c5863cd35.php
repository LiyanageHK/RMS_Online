<?php $__env->startSection('title', 'Employee Registration'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="Full Name" name="name" value="<?php echo e(old('name')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="NIC Number" name="nic" value="<?php echo e(old('nic')); ?>" 
                   required>
            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" 
                ...
                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($role->role); ?>" <?php echo e(old('position') == $role->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="Phone Number" name="phone" value="<?php echo e(old('phone')); ?>">
            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="Address Line 1" name="address_line1" value="<?php echo e(old('address_line1')); ?>" 
                   required>
            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="Address Line 2" name="address_line2" value="<?php echo e(old('address_line2')); ?>">
            <span class="input-group-text">
                <i class="fas fa-map-marker-alt"></i>
            </span>
        </div>
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="City" name="city" value="<?php echo e(old('city')); ?>" 
                   required>
            <span class="input-group-text">
...
unset($__errorArgs, $__bag); ?>" 
                   placeholder="Postal Code" name="postal_code" value="<?php echo e(old('postal_code')); ?>" 
                   required>
            <span class="input-group-text">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\auth\register.blade.php ENDPATH**/ ?>