...
<section style="position: relative; padding: 160px 20px 120px; text-align: center; background: linear-gradient(135deg, rgba(0,0,0,0.6), rgba(0,0,0,0.7)), url('<?php echo e(asset('images/contact.jpg')); ?>') center/cover no-repeat;">
...
<section style="background-color: #fff; padding: 80px 20px;">
    <div class="container" style="max-width: 1000px; margin: 0 auto;">
        ...
        <form action="<?php echo e(route('client.contact.submit')); ?>" method="POST" style="background-color: #fdfdfd; padding: 40px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 700px; margin: auto;">
            <?php echo csrf_field(); ?>
...
<section style="background-color: #f7f7f7; padding: 80px 20px;">
    <div class="container" style="display: flex; flex-wrap: wrap; gap: 50px; justify-content: center; align-items: flex-start; max-width: 1100px; margin: auto;">
        ...
        <div style="flex: 1; min-width: 300px; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.15);">
            <img loading="lazy" src="<?php echo e(asset('images/map-location.png')); ?>" alt="Location Map" style="width: 100%; display: block; transition: transform 0.3s;">
        </div>
    </div>
</section>
...
<section style="background-color: #ffffff; padding: 80px 20px;">
    <div class="container" style="max-width: 1000px; margin: auto; text-align: center;">
        ...
        <form action="<?php echo e(route('client.feedback.submit')); ?>" method="POST" style="background-color: #fdfdfd; padding: 40px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); max-width: 700px; margin: auto;">
            <?php echo csrf_field(); ?>
            <div style="margin-bottom: 25px;">
                <input type="text" name="name" placeholder="Your Name" required
                       style="width: 100%; padding: 16px; font-size: 18px; border: 1px solid #ccc; border-radius: 8px;">
...
<script>
    ...
    <?php if(session('feedback_success')): ?>
        Swal.fire({
            icon: 'success',
            title: 'Thank You!',
            text: "<?php echo e(session('feedback_success')); ?>",
            confirmButtonColor: '#E7592B'
        });
    <?php endif; ?>
</script>
...
<?php echo $__env->make('layouts.appclient', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\client\contact.blade.php ENDPATH**/ ?>