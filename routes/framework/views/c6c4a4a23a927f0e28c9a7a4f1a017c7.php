    ...
    <div id="sidebarMenu" style="flex-grow: 1;">
         ...
         <div>
          ...
          <div>
            ...
            <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
                ...
                <a href="<?php echo e(route('loyalty-program')); ?>"  class="submenu-link" onclick="showLoyaltyTable()">Loyalty Program</a>
                <a href="<?php echo e(route('customer.emailService')); ?>" class="submenu-link">Email Services</a>
        ...
        <div>
            ...
            <div class="submenu" style="display: none; margin-left: 20px; margin-top: 6px; text-align: left;">
                ...
                <a href="<?php echo e(route('delivery.history')); ?>" class="submenu-link">History</a>
                <a href="<?php echo e(route('driver.list')); ?>" class="submenu-link">Driver</a>
                <a href="<?php echo e(route('pending-allocation')); ?>" class="submenu-link">Driver Allocation</a>
            </div>
        </div>
...
<?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\partials\sidebar.blade.php ENDPATH**/ ?>