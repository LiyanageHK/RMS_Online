...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <p>Don't have an account? <a href="<?php echo e(route('register')); ?>">Register here</a></p>
         ...
         <!-- Admin Question -->
        <p>Are you an Admin?<a href="<?php echo e(route('admin.login')); ?>">Click here</a></p>
    </div>
...
<?php echo $__env->make('layouts.appclient', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views/login.blade.php ENDPATH**/ ?>