        ...
        <form action="<?php echo e(route('suppliers.store')); ?>" method="POST">
            ...
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 8px; background-color: #F9F9F9; margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Enter Supplier Name" style="width: 97%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                </div>
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <select id="category" name="category" required style="width: 99%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                        ...
                        <option value="Vegetables" <?php echo e(old('category') == 'Vegetables' ? 'selected' : ''); ?>>Vegetables</option>
                        <option value="Meat" <?php echo e(old('category') == 'Meat' ? 'selected' : ''); ?>>Meat</option>
                        <option value="Seafood" <?php echo e(old('category') == 'Seafood' ? 'selected' : ''); ?>>Seafood</option>
                    </select>
                </div>

                <div style="margin-bottom: 15px;">
                    <label for="email" style="font-weight: bold;">Email Address <span style="color: red;">*</span></label>
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="example@example.com" style="width: 97%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" required placeholder="+94XXXXXXXXX" style="width: 97%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" id="address" name="address" value="<?php echo e(old('address')); ?>" required placeholder="Enter Address" style="width: 97%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                </div>
            </div>
            ...
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 8px; background-color: #F9F9F9;">
                ...
                <div style="display: flex; gap: 20px; margin-bottom: 15px;">
                    <div style="flex: 1;">
                        ...
                        <input type="text" id="contact_person_name" name="contact_person_name" value="<?php echo e(old('contact_person_name')); ?>" placeholder="Enter Conatct Person Name" style="width: 93%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                    </div>

                    <div style="flex: 1;">
                        <label for="contact_person_phone" style="font-weight: bold;">Contact Number</label>
                        <input type="text" id="contact_person_phone" name="contact_person_phone" value="<?php echo e(old('contact_person_phone')); ?>" placeholder="+94XXXXXXXXXr" style="width: 93%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="email" id="contact_person_email" name="contact_person_email" value="<?php echo e(old('contact_person_email')); ?>" placeholder="example@example.com" style="width: 97%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\Suppliers\create.blade.php ENDPATH**/ ?>