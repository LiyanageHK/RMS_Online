        ...
        <div class="footer-container" style="gap: 156px;">
            <div class="footer-about" style="padding-left: -50px;">
                <div style="text-align: center;" >
                    <img src="<?php echo e(asset('uploads/logo/logo2.png')); ?>" alt="Flame & Crust Pizzeria Logo" class="logo" style="width: 100px; height: auto;padding-left: 0px;margin-left: 0px;">
                </div>
...
<?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views/partials/footer.blade.php ENDPATH**/ ?>