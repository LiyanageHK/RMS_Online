...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="display-6 mb-0">Welcome Back, <?php echo e(Auth::user()->name); ?>!</h1>
                ...
                <div class="card-body position-relative">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <h2 class="card-title mb-0 display-6"><?php echo e($totalItems); ?></h2>
                        </div>
                    </div>
                ...
                <div class="card-body position-relative">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <h2 class="card-title mb-0 display-6"><?php echo e($activeProducts); ?></h2>
                        </div>
                    </div>
                    <div class="progress mt-3" style="height: 4px;">
                ...
                <div class="card-body position-relative">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <h2 class="card-title mb-0 display-6"><?php echo e($totalCategories); ?></h2>
                        </div>
                    </div>
                    <div class="progress mt-3" style="height: 4px;">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-3">
                            <a href="<?php echo e(url('/admin/items/create')); ?>" class="text-decoration-none">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(url('/admin/production/create')); ?>" class="text-decoration-none">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(url('/admin/categories/create')); ?>" class="text-decoration-none">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(url('/admin/role/create')); ?>" class="text-decoration-none">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const salesChart = new Chart(salesCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: <?php echo json_encode(array_column($monthlySales, 'count')); ?>,
                    borderColor: '#0d6efd',
        ...
        const orderChart = new Chart(orderCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($totalProducts - $activeProducts); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\HIRUNI LIYANAGE\SLIIT\Y3\S2\IE3011 - IS Project Management\ASSIGNMENT\RMS v2\RMS_Online\resources\views\home.blade.php ENDPATH**/ ?>