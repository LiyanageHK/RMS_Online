        ...
        <div style="background: white; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 30px 30px;">
                ...
                <div style="margin-top: 30px;">
                    ...
                    <form method="POST" action="{{ route('contact.reply', $message->id) }}" style="background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                        @csrf
