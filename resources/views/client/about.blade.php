...
{{-- Hero Section --}}
<section style="position: relative; padding: 160px 20px 120px; color: white; text-align: center; background: url('{{ asset('images/bg-texture.jpg') }}') center/cover no-repeat;">
